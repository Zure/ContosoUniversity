...
const HomePage: React.FC = () => (
  <div className="max-w-7xl mx-auto px-4 py-12">
    <div className="text-center mb-12">
      <h1 className="text-4xl font-bold text-gray-900 mb-4">Welcome to Contoso University</h1>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
        ...
        <a href="/students" className="text-blue-600 hover:text-blue-800 font-medium">
          Go to Students →
        </a>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
        ...
        <a href="/courses" className="text-green-600 hover:text-green-800 font-medium">
          Go to Courses →
        </a>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
        ...
        <a href="/enrollments" className="text-purple-600 hover:text-purple-800 font-medium">
          Go to Enrollments →
        </a>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
        ...
        <a href="/departments" className="text-yellow-600 hover:text-yellow-800 font-medium">
          Go to Departments →
        </a>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
        ...
        <a href="/instructors" className="text-red-600 hover:text-red-800 font-medium">
          Go to Instructors →
        </a>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
        ...
        <a href="/statistics" className="text-indigo-600 hover:text-indigo-800 font-medium">
          Go to Statistics →
        </a>
      </div>
    </div>
